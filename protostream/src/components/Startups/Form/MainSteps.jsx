    ...
    return (
      <div className="Steps">
        ...
        <div className="instructions">
          ...
          <p className="inst">Step 1 : Go to Startup section and register your mobile number.
          </p>
          <p className="inst">Step 2 : Upload your NDA signed by TBI and submit for verification.
          </p>
        </div>
      </div>
    );
